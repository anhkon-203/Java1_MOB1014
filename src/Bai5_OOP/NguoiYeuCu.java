 ...
 * @author 84362
 */
 //Class   dùng để tạo lớp đối tượng, phải viến hao chữ cái đầu của từ
 ...
 */
  ...
  // Alt + Insert chọn Getter và Setter -> Select All
    ...
    void inRaManHinh(){
        System.out.printf("%s | %d | %s | %s | %d | %f | %f| %f | %f | %s|\n",ten,ns,sdt,soThich,gt,v1,v2,v3,canNang,truongHoc);//Triển khai nốt
    }

    @Override
    public String toString() {
        return "NguoiYeuCu{" + "ten=" + ten + ", ns=" + ns + ", sdt=" + sdt + ", soThich=" + soThich + ", gt=" + gt + ", v1=" + v1 + ", v2=" + v2 + ", v3=" + v3 + ", canNang=" + canNang + ", truongHoc=" + truongHoc + '}';
    }
